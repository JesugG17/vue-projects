...
<template>
    ...
    >
        <article
            class="bg-white w-[95%] max-h-[250px] max-w-[350px] rounded-md shadow-md overflow-y-scroll"
        >
            ...
            <div v-if="props.cartItems.length !== 0" class="p-6 flex flex-col gap-4">
                ...
                />
                <button
                    class="w-full bg-orange text-white font-bold py-4 rounded-md shadow-md shadow-orange"
                >
                    Checkout
                </button>
            </div>
            <div
                ...
                class="h-[150px] flex justify-center items-center"
            >
