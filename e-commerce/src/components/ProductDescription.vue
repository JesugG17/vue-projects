...
<template>
    <section class="flex flex-col py-4 px-6 gap-3 lg:mt-10 xl:w-[40%]">
        ...
        <p class="text-gray-600 text-sm md:text-base lg:text-lg">
            ...
            rubber outer sole, the'll withstand everything the weather can offer
        </p>
        ...
        <article class="flex flex-col gap-2 md:flex-row md:mt-3 lg:mt-">
            <button
                class="w-full flex items-center justify-between bg-light-grayish-blue p-4 rounded-md md:w-[40%]"
            >
                <img
